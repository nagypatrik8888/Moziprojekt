...
--
-- Gép: localhost:8889
-- Létrehozás ideje: 2026. Jan 28. 12:25
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_all_rooms` ()   BEGIN
    SELECT 
        id,
        room_id,
        row_num,
...
INSERT INTO `films` (`id`, `title`, `duration_min`, `release_date`, `description`, `genre_id`, `language`, `rating`, `created_at`, `updated_at`) VALUES
(1, 'Gladiator II', 105, '2024-05-10', '', 0, '', 0, NULL, NULL),
(2, 'Dune: Part Two', 130, '2023-11-01', '', 0, '', 0, NULL, NULL),
(3, 'Deadpool & Wolverine', 110, '2025-03-15', '', 0, '', 0, NULL, NULL),
(4, 'The First Omen', 125, '2024-07-20', '', 0, '', 0, NULL, NULL),
(5, 'Furiosa', 140, '2025-06-01', '', 0, '', 0, NULL, NULL);
...
(1, 'Felnőtt', 4000, NULL, NULL),
(2, 'Diák/Nyugdíjas', 3600, NULL, NULL),
(3, 'Gyerek', 2000, NULL, NULL),
(4, 'Csoportos(Ft/Fő)', 3500, NULL, NULL);
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `email`, `password`, `phone`, `salt`, `updated_at`, `created_at`) VALUES
(8, 'user4', 'user4', 'user4@gmail.com', 'bddd23b71ca9d0e34a41bb01e5b0fe651edca2674ea06eca5e8ac893dcf02135', '01234567899', '33c1b618c5f9e8c5', '2026-01-28 11:55:52', NULL),
(9, 'user2', 'user2', 'user2@gmail.com', '3aa149dcca451211c5e88beb1e1753908ddd7439e5b6c2863092a5fdfb751b71', '01234567890', '11758e4a609844b6', NULL, NULL),
(10, 'user2', 'user2', 'user2@gmail.com', '81b576095bbe9fa751cf22003021b0bd5226d99a5fddf991a85d926421654283', '01234567890', '09dcfbcba67085f2', NULL, NULL),
(11, 'user2', 'user2', 'user2@gmail.com', 'e8324bbf6f2004e5d3918f0c01abc64cef97eb3fc3224c6402415dea3d23dcd7', '01234567890', '687e9b25583f3805', NULL, NULL);
